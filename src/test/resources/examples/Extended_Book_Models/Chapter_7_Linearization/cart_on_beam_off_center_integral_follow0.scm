...
<model name="cart_on_beam_off_center_integral_follow0">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="06/11/18 21:53:17"/>
  ...
  <diagram>
      ...
      <diagram>
        ...
        <block name="T" type="regular_in_port">
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-200.21874237060547" y="287.8603210449219"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
        ...
        <block name="SuperBlock" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-176.0542755126953" y="368.65875244140625"/>
        ...
        <block name="Split" type="regular_split">
          ...
          <graphics>
            ...
            <background color="64,64,64,255"/>
            <position x="-10.165840148925781" y="275.03253173828125"/>
        ...
        <block name="Sum" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="24.958938598632813" y="264.8603210449219"/>
        ...
        <block name="ref" type="regular_in_port">
          <template name="system/Ports/Input"/>
          <properties>
            <property name="inlinable" value="0"/>
            <property name="masked" value="1"/>
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-203.18022918701172" y="331.34368896484375"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.35" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">2</text>
        ...
        <link name="" type="Explicit">
          ...
          <pen shape="line" color="64,64,64,255" thickness="1.5"/>
          <points>
            <point x="-10.165840148925781" y="282.8603210449219"/>
          </points>
        </link>
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
        ...
        <link name="" type="Explicit">
          ...
          <pen shape="line" color="64,64,64,255" thickness="1.5"/>
          <points>
            <point x="-10.165840148925781" y="273.8603210449219"/>
          </points>
        </link>
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
        ...
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
          <from block="ref" port="1" iotype="out"/>
          <to block="Sum" port="2" iotype="in"/>
          <pen shape="line" color="64,64,64,255" thickness="1.5"/>
          <points>
            <point x="10.09561824798584" y="341.34368896484375"/>
            <point x="10.09561824798584" y="291.8603210449219"/>
          </points>
        </link>
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <block name="+0.1 -0.1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="38.177124023437116" y="266.13517403151945"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="82.61830139160156" y="256.13517403151945"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="212.47882080078128" y="256.1351740315193"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="+0.1 -0.1" port="1" iotype="out"/>
      <to block="cart on beam" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <annotation name="Annotation" type="text">
