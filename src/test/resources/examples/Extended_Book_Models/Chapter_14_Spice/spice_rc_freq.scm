...
<model name="spice_rc_freq">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="08/29/18 08:46:12"/>
      <property name="comments" value="Frequency analysis of a Spice netlist, using &quot;AC&quot; option in the SpiceCustomBlock"/>
    </properties>
  </edition>
  <initialization/>
  <diagram>
    <block name="frequencey_sweep" type="block">
      ...
      <graphics>
        ...
        <position x="-84.47636413574224" y="-131.59584045410156"/>
    ...
    <block name="SpiceCustomBlock_1" type="block">
      ...
      <graphics>
        ...
        <position x="-402.52842712402344" y="-185.1049575805664"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="code" value="[&apos;*LPFILTER.CIR - SIMPLE RC LOW-PASS FILTER&apos;,char(10),&apos;*&apos;,char(10),&apos;VS&apos;,char(9),&apos;1&apos;,char(9),&apos;0&apos;,char(9),&apos;AC&apos;,char(9),&apos;1&apos;,char(9),&apos;SIN(1  1    2KHZ)&apos;,char(10),&apos;*&apos;,char(10),&apos;R1&apos;,char(9),&apos;1&apos;,char(9),&apos;2&apos;,char(9),&apos;1K&apos;,char(10),&apos;C1&apos;,char(9),&apos;2&apos;,char(9),&apos;0&apos;,char(9),&apos;0.032UF&apos;,char(10),&apos;*&apos;,char(10),&apos;* ANALYSIS&apos;,char(10),&apos;.AC &apos;,char(9),&apos;DEC &apos;,char(9),&apos;5 10 10MEG&apos;,char(10),&apos;.TRAN &apos;,char(9),&apos;5US  500US&apos;,char(10),&apos;*&apos;,char(10),&apos;* VIEW RESULTS&apos;,char(10),&apos;.PRINT&apos;,char(9),&apos;AC &apos;,char(9),&apos;VM(2) VP(2)&apos;,char(10),&apos;.PRINT&apos;,char(9),&apos;TRAN &apos;,char(9),&apos;V(1) V(2)&apos;,char(10),&apos;*&apos;,char(10),&apos;.PROBE&apos;,char(10),&apos;.END&apos;]"/>
          <parameter name="acanalysis" value="1"/>
          <parameter name="nin" value="0"/>
          <parameter name="inputs_names" value="{}"/>
          <parameter name="nout" value="1"/>
          <parameter name="outputs_names" value="{&apos;2&apos;}"/>
    ...
    <block name="Ramp" type="block">
      ...
      <graphics>
        ...
        <position x="-516.8732299804688" y="-213.27092933654785"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="slope" value="1000"/>
    ...
    <block name="ScopeXY_log_log" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-78.90435791015625" y="-282.2239685058594"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        ...
        <section name="Advanced">
          ...
          <parameter name="plotColor" value="0"/>
          <parameter name="plotGrid" value="&apos;Coarse&apos;"/>
          <parameter name="xScale" value="&apos;log&apos;"/>
          <parameter name="xInterval" value="[NaN,NaN]"/>
          <parameter name="yScale" value="&apos;log&apos;"/>
          <parameter name="yInterval" value="[NaN,NaN]"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="-446.47930908203125" y="-193.27092933654785"/>
    ...
    <block name="ComplexDecomposition" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-236.40872955322266" y="-181.14382362365723"/>
    ...
    <block name="Block_1" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-446.47930908203125" y="-161.1049575805664"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="ScopeXY_linear" type="block">
      <template name="system/SignalViewers/ScopeXY"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="36.94258117675781" y="-282.2239685058594"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block_2" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-125.41224670410156" y="-272.2239685058594"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block_3" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-125.41224670410156" y="-209.68464660644534"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-446.47930908203125" y="-272.2239685058594"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ScopeXY_log_log" port="2" iotype="in"/>
      <to block="Block_3" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-125.41224670410156" y="-252.22396850585932"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SpiceCustomBlock_1" port="1" iotype="out"/>
      <to block="ComplexDecomposition" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-249.09634399414062" y="-161.10495758056643"/>
        <point x="-249.09634399414068" y="-161.14382362365723"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SpiceCustomBlock_1" port="1" iotype="in"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="frequencey_sweep" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-446.4793090820315" y="-111.59584045410155"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ScopeXY_linear" port="1" iotype="in"/>
      <to block="Block_2" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="1.8847961425781463" y="-272.2239685058594"/>
        <point x="1.8847961425781399" y="-304.8878784179688"/>
        <point x="-125.41224670410156" y="-304.8878784179688"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block_2" port="1" iotype="out"/>
      <to block="ScopeXY_log_log" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ScopeXY_linear" port="2" iotype="in"/>
      <to block="Block_3" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-0.3769073486328125" y="-252.22396850585938"/>
        <point x="-0.3769073486328046" y="-209.68464660644537"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block_3" port="1" iotype="in"/>
      <to block="ComplexDecomposition" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-125.4122467041016" y="-171.14382362365723"/>
      </points>
    </link>
    <annotation name="Annotation" type="text">
      <frame shape="rectangle" visible="0" color="31,73,125,255" cornerradius="0" thickness="1.5"/>
      <background color="0,0,0,0"/>
      <position x="-416.10205078125" y="-223.22882843017578"/>
      <size width="262" height="40"/>
      <rotate angle="0"/>
      <text font="Arial,8" color="31,73,125,255">Frequency analysis of a Spice netlist, &#xA;using &quot;AC&quot; option in the SpiceCustomBlock</text>
    </annotation>
    <context/>
    <graphics>
