...
<model name="simpleODE">
  <header formatversion="2" hwxversion="2018.1" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Altair Engineering Inc."/>
      <property name="creationdate" value="12/16/15 08:56:18"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="03/19/18 01:41:49"/>
  ...
  <diagram>
    <block name="MoCustomBlock" type="block">
      ...
      <ports>
        <port name="&quot;x&quot; &quot;y&quot;" type="variableport">
          <properties>
      ...
      <parameters>
        ...
        <section name="Parameters">
          <parameter name="nparams" value="0"/>
        ...
        <section name="SimFunction">
          <parameter name="codename" value="&apos;simpleODE&apos;"/>
          <parameter name="code" value="[&apos;model simpleODE &apos;,char(10),&apos;    Real x(start =5);&apos;,char(10),&apos;   Real y(start=2);&apos;,char(10),&apos;   Real u;&apos;,char(10),&apos;equation&apos;,char(10),&apos;   der(x)=2-15*y+u;&apos;,char(10),&apos;   der(y)=x+6;&apos;,char(10),&apos;end simpleODE;&apos;]"/>
    ...
    <annotation name="Annotation_1" type="text">
      ...
      <position x="-58.796387" y="-58.04306"/>
      <size width="116" height="28"/>
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">simpleODE.scm</text>
    </annotation>
    <context/>
    <graphics>
