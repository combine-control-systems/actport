...
<model name="DrainingTanks_C">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="03/19/18 01:42:44"/>
  ...
  <diagram>
    <block name="Mux" type="block">
      ...
      <graphics>
        ...
        <position x="815.329529" y="134.772736"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="800.3635860000001" y="149.772736"/>
    ...
    <block name="End" type="block">
      ...
      <graphics>
        ...
        <position x="878.067139" y="268.678833"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="785.547119" y="179.772736"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Time" type="block">
      ...
      <graphics>
        ...
        <position x="732.928955" y="268.678833"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="SuperBlock" type="block">
      <diagram>
        <block name="IfThenElse" type="block">
          ...
          <graphics>
            ...
            <position x="1119.37146" y="268.942871"/>
        ...
        <block name="Sum" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="870.698181" y="235.625061"/>
            <size width="36" height="47.99999999999997"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
            </texts>
        ...
        <block name="Bias" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="1021.10718" y="280.942871"/>
        ...
        <block name="EventOutput" type="activation_out_port">
          ...
          <graphics>
            ...
            <background color="255,255,255,255"/>
            <position x="1154.37146" y="360.035736"/>
        ...
        <block name="Input_1_1" type="regular_in_port">
          <template name="system/Ports/Input"/>
          <properties>
            <property name="inlinable" value="0"/>
            <property name="masked" value="1"/>
        ...
        <block name="MaxMin" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="870.698181" y="308.632141"/>
            <size width="40" height="40"/>
            <rotate angle="0"/>
            <texts>
        ...
        <block name="ConditionalSelect" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="944.744629" y="278.942871"/>
        ...
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
          <from block="Input_1_1" port="1" iotype="out"/>
        ...
        <link name="" type="Explicit">
          ...
          <pen shape="line" color="64,64,64,255" thickness="1.5"/>
          <points>
            <point x="920.698181" y="285.610462"/>
          </points>
        </link>
        <link name="" type="Explicit">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
          ...
          <pen shape="line" color="64,64,64,255" thickness="1.5"/>
          <points>
            <point x="930.737" y="259.625061"/>
            <point x="930.737" y="312.276"/>
          </points>
        </link>
        <context/>
        <graphics>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,0,0,255"/>
        <position x="878.067139" y="208.678833"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="two-tank" type="block">
      ...
      <ports>
        <port name="&quot;h1&quot; &quot;h2&quot;" type="variableport">
          <properties>
            <property name="iotype" value="out"/>
            <property name="datatype" value="Explicit"/>
        ...
        <port name="&quot;pump&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="nin"/>
      ...
      <parameters>
        ...
        <section name="States">
          <parameter name="xx" value="[h10;h20;2.24;.01]"/>
        ...
        <section name="SimFunction">
          ...
          <parameter name="code" value="[&apos;#include &quot;vss_block4.h&quot;&apos;,char(10),&apos;VSS_EXPORT void CBlockFunction(vss_block *block,int flag)&apos;,char(10),&apos;{&apos;,char(10),&apos;  SCSREAL_COP pump=*(SCSREAL_COP *)GetInPortPtrs(block,1);&apos;,char(10),&apos;  SCSREAL_COP *h1=(SCSREAL_COP *)GetOutPortPtrs(block,1);&apos;,char(10),&apos;  SCSREAL_COP *h2=(SCSREAL_COP *)GetOutPortPtrs(block,2);&apos;,char(10),&apos;  SCSREAL_COP *x=GetState(block);&apos;,char(10),&apos;  SCSREAL_COP *xd=GetDerState(block);&apos;,char(10),&apos;  SCSREAL_COP *res=GetResState(block);&apos;,char(10),&apos;  SCSREAL_COP L=*(SCSREAL_COP *)GetOparPtrs(block,1);&apos;,char(10),&apos;  SCSREAL_COP D=*(SCSREAL_COP *)GetOparPtrs(block,2);&apos;,char(10),&apos;  SCSREAL_COP rho=*(SCSREAL_COP *)GetOparPtrs(block,3);&apos;,char(10),&apos;  SCSREAL_COP mu=*(SCSREAL_COP *)GetOparPtrs(block,4);&apos;,char(10),&apos;  SCSREAL_COP At=*(SCSREAL_COP *)GetOparPtrs(block,5);&apos;,char(10),&apos;  SCSREAL_COP e=*(SCSREAL_COP *)GetOparPtrs(block,6);&apos;,char(10),&apos;  SCSREAL_COP Ks=*(SCSREAL_COP *)GetOparPtrs(block,7);&apos;,char(10),&apos;  SCSREAL_COP ReL=*(SCSREAL_COP *)GetOparPtrs(block,8);&apos;,char(10),&apos;  SCSREAL_COP ReT=*(SCSREAL_COP *)GetOparPtrs(block,9);&apos;,char(10),&apos;  SCSREAL_COP fT=*(SCSREAL_COP *)GetOparPtrs(block,10);&apos;,char(10),&apos;  SCSREAL_COP pi=3.14, g=9.81, V, f, Q, H, Re, Ad, fL;&apos;,char(10),&apos;  switch (flag){&apos;,char(10),&apos;   case VssFlag_OutputUpdate:&apos;,char(10),&apos;&#x9;*h1=x[0];&#x9;&apos;,char(10),&apos;&#x9;*h2=x[1];&apos;,char(10),&apos;    break;&apos;,char(10),&apos;  case VssFlag_Derivatives:&apos;,char(10),&apos;&#x9;Ad=D*D*pi/4;fL=Ks/ReL;&apos;,char(10),&apos;&#x9;V=x[2];f=x[3];&apos;,char(10),&apos;&#x9;Q=pi*V*D*D/4;&apos;,char(10),&apos;&#x9;H=pump*(4-8.0e4*Q*Q);&apos;,char(10),&apos;    Re=D*V*rho/mu;&apos;,char(10),&apos;    res[0]=x[1]+f*2*L*V*V/(D*2*g)+V*V/(2*g)-x[0]-H;&apos;,char(10),&apos;    res[1]=xd[0]+V*Ad/At;&apos;,char(10),&apos;    res[2]=xd[1]-V*Ad/At;&apos;,char(10),&apos;    if (Re&gt;ReT) res[3]=1/sqrt(f)+2*log10(e/3.7+2.51/(Re*sqrt(f)));&apos;,char(10),&apos;    else if (Re&lt;ReL) res[3]=f-Ks/Re;&apos;,char(10),&apos;&#x9;else res[3]=fL+(fT-fL)*(Re-ReL)/(ReT-ReL)-f;&apos;,char(10),&apos;    break;&apos;,char(10),&apos;  }&apos;,char(10),&apos;}&apos;,char(10)]"/>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="238,226,235,255"/>
        <position x="798.56189" y="270.678833"/>
        <size width="60" height="36"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">0</text>
    ...
    <block name="SignalOut" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="878.067139" y="91.903519"/>
    ...
    <block name="Block_2" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="849.204102" y="164.772736"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="878.067139" y="144.772736"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        <section name="Main">
          ...
          <parameter name="winPos" value="[355;500]"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="two-tank" port="1" iotype="out"/>
      <to block="Split" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="800.3635860000001" y="150"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="two-tank" port="2" iotype="out"/>
      <to block="Block" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="785.547119" y="168"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="800.3635860000001" y="215.34519"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="785.547119" y="228.678935"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ManualSelect" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="SuperBlock" port="3" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="628.26999" y="242.012022"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block_1" port="1" iotype="out"/>
      <to block="two-tank" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="529.319961" y="204"/>
        <point x="529.319961" y="169"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="849.204102" y="111.90351900000002"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <annotation name="Annotation" type="text">
      ...
      <position x="498.867149" y="255.839203"/>
      <size width="147.99999999999994" height="28"/>
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">DrainingTanks_C.scm</text>
    </annotation>
    <context>h10=3;&#xA;h20=0;&#xA;</context>
    <graphics>
      <viewport width="800" height="800" topleftx="0" toplefty="0"/>
