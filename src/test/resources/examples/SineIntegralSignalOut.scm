...
<model name="SineIntegralSignalOut">
  <header formatversion="2" hwxversion="2018.1" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="solidThinking Inc."/>
      <property name="creationdate" value="06/08/15 13:25:48"/>
      <property name="revision" value="1.0"/>
      <property name="lastmodifieddate" value="03/19/18 01:44:57"/>
  ...
  <diagram>
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <position x="187.401855" y="-28.03521"/>
    ...
    <block name="Mux" type="block">
      ...
      <graphics>
        ...
        <position x="439.901825" y="-53.03521"/>
    ...
    <block name="Integral" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="309.401825" y="-38.03521"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="272.40184" y="-8.035209999999999"/>
    ...
    <block name="SignalOut" type="block">
      ...
      <graphics>
        ...
        <position x="502.401855" y="-43.03521"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="varname" value="&apos;data&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="272.40184" y="-78.53521000000001"/>
        <point x="394.901855" y="-78.53521000000001"/>
        <point x="394.901855" y="-38.03521"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
  ...
  <simulation>
    <properties>
      ...
      <property name="FinalTime" value="4*pi"/>
