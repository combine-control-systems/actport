...
<model name="matrix_division">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/20/19 10:20:01"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/20/19 10:24:01"/>
  ...
  <finalization/>
  <diagram>
    <block name="MatrixDivision" type="block">
      <template name="system/MatrixOperations/MatrixDivision"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-826.0433959960938" y="-1163.575927734375"/>
      ...
      <parameters>
        <section name="Parameters">
          <parametercombobox name="div_typ">
            <parameter name="slash" value="1"/>
            <parameter name="backslash" value="0"/>
          </parametercombobox>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="MatrixDivision_1" type="block">
      <template name="system/MatrixOperations/MatrixDivision"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-826.2606811523438" y="-1096.7569580078125"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        <section name="Parameters">
          <parametercombobox name="div_typ">
            <parameter name="slash" value="0"/>
            <parameter name="backslash" value="1"/>
          </parametercombobox>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-947.1968383789063" y="-1210.607421875"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Constant_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-947.7688598632814" y="-1153.575927734375"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">[4,3;2,1]</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="C" value="[4,3;2,1]"/>
          <parameter name="typ" value="&apos;double&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="-849.1651611328125" y="-1153.575927734375"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-857.6776733398438" y="-1133.575927734375"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-749.6142578125" y="-1167.4337158203125"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">      1.5     -2.5&#xA;      2.5     -3.5</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Display_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-749.4769287109375" y="-1100.61474609375"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">       -6       -5&#xA;        5        4</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-866.6201171874999" y="-1190.607421875"/>
        <point x="-866.6201171875" y="-1153.575927734375"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="MatrixDivision" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      ...
      <to block="MatrixDivision_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-849.1651611328125" y="-1086.7569580078125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block" port="1" iotype="out"/>
      <to block="MatrixDivision" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      ...
      <to block="MatrixDivision_1" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-857.6776733398438" y="-1066.7569580078125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MatrixDivision_1" port="1" iotype="out"/>
      <to block="Display_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-767.8688049316406" y="-1076.7569580078125"/>
        <point x="-767.8688049316406" y="-1076.61474609375"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MatrixDivision" port="1" iotype="out"/>
      <to block="Display" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-767.8288269042969" y="-1143.575927734375"/>
        <point x="-767.8288269042969" y="-1143.4337158203125"/>
      </points>
    </link>
    <context/>
    <graphics>
