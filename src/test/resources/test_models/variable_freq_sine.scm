...
<model name="variable_freq_sine">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/03/19 12:01:51"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 12:06:13"/>
  ...
  <finalization/>
  <diagram>
    <block name="VariableFreqSine" type="block">
      <template name="system/SignalGenerators/VariableFreqSine"/>
      <properties>
      ...
      <graphics>
        ...
        <images>
          <image name="image1" file="SignalGenerators/variableFreqSine.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="SignalGenerators/variableFreqSine.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="FInit" value="0.2"/>
          <parameter name="IncreaseRate" value="0.05"/>
        </section>
      </parameters>
    </block>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="VariableFreqSine" port="1" iotype="out"/>
  ...
  <simulation>
    <properties>
      ...
      <property name="TimeTolerance" value="0.01"/>
      <property name="Solver" value="lsodar"/>
      <property name="MaxStepSize" value="0.01"/>
      <property name="InitialStepSize" value="0.01"/>
      <property name="MinimalStepSize" value="0.01"/>
