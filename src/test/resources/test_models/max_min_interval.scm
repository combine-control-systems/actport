...
<model name="max_min_interval">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="07/09/19 07:44:08"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="07/09/19 08:01:22"/>
  ...
  <finalization/>
  <diagram>
    <block name="MaxMinInterval" type="block">
      <template name="system/Buffers/MaxMinInterval"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-178.5" y="262"/>
        <size width="60" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Max over&#xA;interval</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="mm" value="&apos;Max&apos;"/>
          <parameter name="initial" value="0.0"/>
    ...
    <block name="MaxMinInterval_1" type="block">
      <template name="system/Buffers/MaxMinInterval"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-178.5" y="333"/>
        <size width="60" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Min over&#xA;interval</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MaxMinInterval" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="MaxMinInterval" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      ...
      <to block="MaxMinInterval_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-222.5" y="353"/>
      </points>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MaxMinInterval_1" port="1" iotype="out"/>
