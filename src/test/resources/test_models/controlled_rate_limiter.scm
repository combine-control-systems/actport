...
<model name="controlled_rate_limiter">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 12:47:51"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 12:50:52"/>
  ...
  <diagram>
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <position x="127.08292007446289" y="-37.93590799967447"/>
    ...
    <block name="Step Generator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-110.91707992553711" y="-92.10257466634116"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Step Generator_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-105.91707992553711" y="13.06409200032553"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="steptime" value="20"/>
          <parameter name="iniv" value="0.5"/>
          <parameter name="finv" value="1"/>
        </section>
      </parameters>
    </block>
    <block name="ControlledRateLimiter" type="block">
      <template name="system/Hybrid/ControlledRateLimiter"/>
      <properties>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-8.917079925537109" y="-41.51924133300781"/>
        <size width="84" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.6" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Controlled&#xA;RateLimiter</text>
        </texts>
        <images>
    ...
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-113.91708374023438" y="-39.51924133300781"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ControlledRateLimiter" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="101.08292007446289" y="-21.519241333007813"/>
        <point x="101.08292007446289" y="-17.93590799967447"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SineWaveGenerator" port="1" iotype="out"/>
      <to block="ControlledRateLimiter" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-41.41708183288574" y="-19.519241333007813"/>
        <point x="-41.41708183288574" y="-21.519241333007813"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator_1" port="1" iotype="out"/>
      <to block="ControlledRateLimiter" port="3" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-37.41707992553711" y="33.06409200032553"/>
        <point x="-37.41707992553711" y="-8.185907999674484"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ControlledRateLimiter" port="1" iotype="in"/>
      <to block="Step Generator" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-39.91707992553711" y="-34.85257466634115"/>
        <point x="-39.91707992553711" y="-72.10257466634116"/>
      </points>
    </link>
    <context/>
    <graphics>
