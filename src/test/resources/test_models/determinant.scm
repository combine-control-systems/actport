...
<model name="determinant">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="07/03/19 10:11:48"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="07/03/19 10:12:28"/>
  ...
  <finalization/>
  <diagram>
    <block name="Determinant" type="block">
      <template name="system/MatrixOperations/Determinant"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-99.03353881835938" y="-174.87037658691406"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Det</text>
        </texts>
        <images>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-217.03353881835938" y="-174.87037658691406"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="9.966457366943359" y="-178.87037658691406"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">       -2</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <link name="" type="Explicit">
      ...
      <to block="Determinant" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Determinant" port="1" iotype="out"/>
