...
<model name="extract_activation">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/28/19 08:27:53"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/28/19 08:30:20"/>
  ...
  <diagram>
    <block name="ExtractActivation" type="block">
      ...
      <graphics>
        ...
        <position x="359.9459228515625" y="152.91600036621094"/>
    ...
    <block name="SquareWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="252.9459228515625" y="152.91600036621094"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="dutyCycle" value="1"/>
    ...
    <block name="EventScope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="369.94592285156256" y="242.91598510742188"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="375.9459228515625" y="50.915977478027344"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="322.9459228515625" y="172.91600036621094"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="322.9459228515625" y="70.91597747802734"/>
      </points>
    </link>
    <context/>
    <graphics>
  ...
  <simulation>
    <properties>
      ...
      <property name="FinalTime" value="4"/>
