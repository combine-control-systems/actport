...
<model name="discrete_derivative">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 08:57:04"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 09:05:13"/>
  ...
  <finalization/>
  <diagram>
    <block name="DiscreteDerivative" type="block">
      <template name="system/Dynamical/DiscreteDerivative"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="30.748695373535156" y="136.6426239013672"/>
        <size width="60" height="60"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">z-1&#xA;───&#xA;T.z</text>
        </texts>
        <images>
    ...
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-74.25130462646484" y="141.6426239013672"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="145.74868774414063" y="151.6426239013672"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="SampleClock" type="block">
      ...
      <graphics>
        ...
        <position x="56.748695373535156" y="45.64262390136719"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.25" rotate="1" visible="1" font="Arial,12" align="center">0.5</text>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="frequ" value="0.5"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="DiscreteDerivative" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="118.24869155883789" y="171.6426239013672"/>
        <point x="118.24869155883789" y="166.6426239013672"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="DiscreteDerivative" port="1" iotype="in"/>
      <to block="SineWaveGenerator" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-1.7513046264648438" y="166.6426239013672"/>
        <point x="-1.7513046264648438" y="161.6426239013672"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampleClock" port="1" iotype="out"/>
      <to block="DiscreteDerivative" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="76.74869537353516" y="111.14262390136719"/>
        <point x="60.748695373535156" y="111.14262390136719"/>
      </points>
    </link>
    <context/>
    <graphics>
