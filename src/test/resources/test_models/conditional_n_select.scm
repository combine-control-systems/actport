...
<model name="conditional_n_select">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="05/21/19 09:15:33"/>
  ...
  <diagram>
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <position x="-276.9583740234375" y="-2.177837371826172"/>
    ...
    <block name="Constant_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-261.6629638671875" y="-54.32423400878906"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Ramp" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-253.2558135986328" y="-107.18379211425781"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="slope" value="0.1"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="35.55801773071289" y="30.02814531326294"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Constant_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-278.43141174316406" y="43.891224443912506"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="ConditionalNSelect" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-121.45935821533203" y="-85.46479034423828"/>
        <size width="96" height="84"/>
        <rotate angle="0"/>
        <texts>
      ...
      <ports>
        ...
        <port name="&quot;case 0:y=u2&quot; &quot;case 1:y=u3&quot; &quot;case 2:y=u4&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="nin"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="base" value="0"/>
          <parameter name="rule" value="&apos;floor&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="ConditionalNSelect_1" type="block">
      <template name="system/Routing/ConditionalNSelect"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-113.06206512451172" y="63.99005126953125"/>
        <size width="96" height="84"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.55" y="0.55" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <ports>
        ...
        <port name="&quot;case 1:y=u2&quot; &quot;case 2:y=u3&quot; &quot;case 3:y=u4&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="nin"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="-182.6172752380371" y="-76.26383972167969"/>
    ...
    <block name="Block_1" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-204.46334838867188" y="17.822162628173828"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block_2" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-224.3009490966797" y="63.891224443912506"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="-189.2036590576172" y="-34.32423400878906"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-182.6172752380371" y="-87.18379211425781"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-2.950670242309571" y="-43.46479034423829"/>
        <point x="-2.950670242309574" y="40.02814531326294"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ConditionalNSelect_1" port="1" iotype="in"/>
      <to block="Split" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-141.89862060546875" y="74.49005126953125"/>
        <point x="-141.89862060546875" y="-76.26383972167969"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-182.6172752380371" y="-74.96479034423828"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ConditionalNSelect_1" port="3" iotype="in"/>
      <to block="Block_1" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-204.46334838867188" y="116.49005126953125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-164.417724609375" y="17.822162628173828"/>
        <point x="-164.417724609375" y="-32.96479034423828"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ConditionalNSelect_1" port="4" iotype="in"/>
      <to block="Block_2" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-224.3009490966797" y="137.49005126953125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block_2" port="1" iotype="out"/>
      <to block="ConditionalNSelect" port="4" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-155.52932739257813" y="63.8912244439125"/>
        <point x="-155.5293273925781" y="-11.964790344238281"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ConditionalNSelect_1" port="1" iotype="out"/>
      <to block="Scope" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="9.247976303100586" y="105.99005126953125"/>
        <point x="9.247976303100586" y="60.02814531326294"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ConditionalNSelect_1" port="2" iotype="in"/>
      <to block="Block" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-189.2036590576172" y="95.49005126953125"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-171.56116104125977" y="-34.32423400878906"/>
        <point x="-171.56116104125977" y="-53.96479034423828"/>
      </points>
    </link>
    <context/>
    <graphics>
