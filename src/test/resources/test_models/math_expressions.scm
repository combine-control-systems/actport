...
<model name="math_expressions">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="05/20/19 14:37:23"/>
  ...
  <diagram>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">[2;  2; 3] </text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="C" value="[2;  2; 3] "/>
          <parameter name="typ" value="&apos;double&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="MathExpressions" type="block">
      <template name="system/MathOperations/MathExpressions"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
        <property name="atomic" value="0"/>
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Math&#xA;Expressions</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="nexx" value="3"/>
          <parametertable name="Exp">
            <columns number="1">
              <parameter name="exx" value="&apos;(u1&gt;0)*sin(u2)&apos;"/>
            </columns>
            <rows number="nexx">
              <row>
                <value>&apos;(u1&gt;0)*sin(u2)&apos;</value>
              </row>
              <row>
                <value>&apos;(u1&lt;0)*cos(u2)&apos;</value>
              </row>
              <row>
                <value>&apos;(u3-u1)&apos;</value>
              </row>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MathExpressions" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="MathExpressions" port="1" iotype="in"/>
