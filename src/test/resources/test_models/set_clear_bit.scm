...
<model name="set_clear_bit">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/04/19 07:56:09"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/04/19 08:51:34"/>
  ...
  <finalization/>
  <diagram>
    <block name="ClearBit" type="block">
      <template name="system/BitOperations/ClearBit"/>
      <properties>
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Clear&#xA;bit: 2</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="Datatype" value="&apos;int32&apos;"/>
          <parameter name="bit" value="2"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="SetBit" type="block">
      <template name="system/BitOperations/SetBit"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
        <property name="atomic" value="0"/>
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Set&#xA;bit: 4</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="DatatypeConversion" type="block">
      ...
      <ports>
        <port name="int32" type="fixedport">
          <properties>
            <property name="iotype" value="out"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="1"/>
        ...
        <port name="double" type="fixedport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="1"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SetBit" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="SetBit" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="1" y="-10"/>
        <point x="1" y="-16"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="Ramp_2" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_2" port="1" iotype="in"/>
      <to block="ClearBit" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="104.5" y="97"/>
        <point x="104.5" y="98"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ClearBit" port="1" iotype="in"/>
      <to block="DatatypeConversion_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="13" y="98"/>
        <point x="13" y="101"/>
