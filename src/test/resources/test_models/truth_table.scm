...
<model name="truth_table">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/03/19 08:33:10"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 09:15:14"/>
  ...
  <finalization/>
  <diagram>
    <block name="TruthTable" type="block">
      <template name="system/LogicalOperations/TruthTable"/>
      <properties>
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Truth&#xA;Table</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="mat" value="[0 1; 0 0; 1 1; 0 1]"/>
    ...
    <block name="TruthTable_1" type="block">
      <template name="system/LogicalOperations/TruthTable"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="1.9534120559692383" y="84.80123901367188"/>
        <size width="60" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Truth&#xA;Table</text>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="mat" value="[1; 0; 0; 0; 1; 1; 0; 1]"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="Step Generator_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-117.04658794403076" y="84.80123901367188"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Step Generator_2" type="block">
      <template name="system/SignalGenerators/StepGenerator"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-118.04658794403076" y="38.801239013671875"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="118.32763671875" y="84.80123901367188"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Step Generator_1_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-116.04658794403076" y="132.80123901367188"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="TruthTable" port="1" iotype="in"/>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="TruthTable" port="2" iotype="in"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="TruthTable" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="75.5" y="-45"/>
        <point x="75.5" y="-44"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="TruthTable" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="75.5" y="-25"/>
        <point x="75.5" y="-24"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator_2" port="1" iotype="out"/>
      <to block="TruthTable_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-36.04658794403079" y="58.80123901367188"/>
        <point x="-36.046587944030776" y="91.46790568033857"/>
      </points>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_1" port="1" iotype="in"/>
      <to block="TruthTable_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="TruthTable_1" port="2" iotype="in"/>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="TruthTable_1" port="3" iotype="in"/>
      <to block="Step Generator_1_1_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-37.04658794403076" y="118.1345723470052"/>
        <point x="-37.04658794403076" y="152.80123901367188"/>
      </points>
    </link>
    <context/>
    <graphics>
