...
<model name="sampled_data">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 09:31:51"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 09:33:43"/>
  ...
  <finalization/>
  <diagram>
    <block name="SampledData" type="block">
      <template name="system/Dynamical/SampledData"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-35.807666063308716" y="163.47467041015625"/>
        <size width="60" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Sampled&#xA;Data</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="discmethod" value="&apos;Standard&apos;"/>
    ...
    <block name="Sum_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-128.60031127929688" y="156.43832063674927"/>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="130.79417419433594" y="144.04874849319458"/>
    ...
    <block name="Step Generator_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-197.60031127929688" y="156.17476320266724"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Gain_1" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,255"/>
        <position x="-11.460710525512695" y="233.73286771774292"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="54.900390625" y="183.47467041015625"/>
    ...
    <block name="SampleClock" type="block">
      ...
      <graphics>
        ...
        <position x="-20.01288026291877" y="82.74942016601563"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-138.60031127929688" y="253.73286771774292"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-143.10031127929688" y="171.43832063674927"/>
        <point x="-143.10031127929688" y="176.17476320266724"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampledData" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="54.900390625" y="253.73286771774292"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="77.49325406551361" y="183.47467041015625"/>
        <point x="77.49325406551361" y="164.04874849319458"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampledData" port="1" iotype="in"/>
      <to block="Sum_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-62.203988671302795" y="183.47467041015625"/>
        <point x="-62.203988671302795" y="186.43832063674927"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampleClock" port="1" iotype="out"/>
      <to block="SampledData" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-0.012880262918767649" y="143.11204528808594"/>
        <point x="-5.807666063308718" y="143.11204528808594"/>
      </points>
    </link>
    <context/>
    <graphics>
