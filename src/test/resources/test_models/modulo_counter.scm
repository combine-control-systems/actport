...
<model name="modulo_counter">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/03/19 12:07:49"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 13:26:05"/>
  ...
  <diagram>
    ...
    <block name="ModuloCounter" type="block">
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="base" value="3.66"/>
          <parameter name="step" value="0.5"/>
    ...
    <block name="ModuloCounter_1" type="block">
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="ini_state" value="2"/>
          <parameter name="base" value="5"/>
          <parameter name="step" value="1"/>
          <parameter name="typ" value="&apos;uint32&apos;"/>
        </section>
      </parameters>
    </block>
    ...
    <block name="ModuloCounter_1_1" type="block">
      <template name="system/SignalGenerators/ModuloCounter"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="1"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="ini_state" value="-1"/>
          <parameter name="base" value="5"/>
          <parameter name="step" value="0.4"/>
          <parameter name="typ" value="&apos;double&apos;"/>
        </section>
      </parameters>
    </block>
    <block name="Block" type="activation_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="183,15,19,255" thickness="1.5"/>
        <background color="183,15,19,255"/>
        <position x="-71" y="45.24999999999999"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ModuloCounter_1" port="1" iotype="in"/>
    ...
    <link name="" type="Activation">
      ...
      <to block="ModuloCounter" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-21.999999999999993" y="-62.5"/>
        <point x="-17.000000000000004" y="-62.5"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ModuloCounter_1_1" port="1" iotype="out"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ModuloCounter_1_1" port="1" iotype="in"/>
      <to block="Block" port="2" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-71.00000000000006" y="123.25"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-74" y="45.24999999999999"/>
        <point x="-74" y="-72.00000000000006"/>
      </points>
    </link>
    <context/>
    <graphics>
