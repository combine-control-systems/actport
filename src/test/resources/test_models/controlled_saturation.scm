...
<model name="controlled_saturation">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 11:17:02"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 11:19:52"/>
  ...
  <finalization/>
  <diagram>
    <block name="ControlledSaturation" type="block">
      <template name="system/Hybrid/ControlledSaturation"/>
      <properties>
    ...
    <block name="Ramp" type="block">
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="initout" value="-12"/>
    ...
    <block name="Step Generator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-163" y="-62.66666666666667"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="iniv" value="-10"/>
          <parameter name="finv" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="Step Generator_1" type="block">
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="iniv" value="5"/>
          <parameter name="finv" value="15"/>
        </section>
      </parameters>
    </block>
    <link name="" type="Explicit">
      ...
      <to block="ControlledSaturation" port="3" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-88.5" y="62.5"/>
        <point x="-88.5" y="24.83333333333333"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator" port="1" iotype="out"/>
      <to block="ControlledSaturation" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-69" y="-42.66666666666667"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Ramp" port="1" iotype="out"/>
      <to block="ControlledSaturation" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-91" y="16.5"/>
        <point x="-91" y="11.5"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="ControlledSaturation" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <context/>
