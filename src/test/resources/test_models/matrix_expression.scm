...
<model name="matrix_expression">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/20/19 10:53:47"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/20/19 11:27:31"/>
  ...
  <diagram>
    <block name="MatrixExpression" type="block">
      ...
      <graphics>
        ...
        <position x="-874.809326171875" y="-1334.7474365234375"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="useinputnames" value="0"/>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-1016.33056640625" y="-1368.838623046875"/>
    ...
    <block name="Constant_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-1016.9308471679688" y="-1315.1290283203125"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">[5,6;7,8]</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="C" value="[5,6;7,8]"/>
          <parameter name="typ" value="&apos;double&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-759.672119140625" y="-1340.7474365234375"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">       19       22&#xA;       43       50</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-925.5699462890625" y="-1348.838623046875"/>
        <point x="-925.5699462890625" y="-1325.7474365234375"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Constant_1" port="1" iotype="out"/>
      <to block="MatrixExpression" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-925.8700866699219" y="-1295.1290283203125"/>
        <point x="-925.8700866699219" y="-1307.7474365234375"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
