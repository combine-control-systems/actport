...
<model name="sort">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="05/24/19 08:56:19"/>
  ...
  <finalization/>
  <diagram>
    <block name="Sort" type="block">
      <template name="system/MatrixOperations/Sort"/>
      <properties>
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Sort</text>
        </texts>
        <images>
      ...
      <ports>
        ...
        <port name="" type="variableport">
          <properties>
            ...
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="1+indexoutput"/>
          </properties>
          <graphics>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="algo" value="&apos;quicksort&apos;"/>
          <parameter name="incdec" value="&apos;Ascending&apos;"/>
          <parameter name="cmplx" value="&apos;Magnitude&apos;"/>
          <parameter name="indexoutput" value="1"/>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">      -56       45       87&#xA;       34       45      123</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Display_1" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">1  3  5&#xA;6  4  2</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Display_2" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="50.33753776550293" y="56.52065467834473"/>
        <size width="132" height="60"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">      -56       45       87&#xA;       34       45      123</text>
    ...
    <block name="Constant_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-121.66246223449707" y="85.02065467834473"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">[-56 45 87; 123 45 34]</text>
    ...
    <block name="Sort_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-34.66246223449707" y="74.02065467834473"/>
        <size width="50" height="50"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Sort</text>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="algo" value="&apos;quicksort&apos;"/>
          <parameter name="incdec" value="&apos;Descending&apos;"/>
          <parameter name="cmplx" value="&apos;Magnitude&apos;"/>
          <parameter name="indexoutput" value="0"/>
          <parameter name="onebased" value="1"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    ...
    <link name="" type="Explicit">
      ...
      <to block="Sort" port="1" iotype="in"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Sort" port="1" iotype="out"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="Sort" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="18" y="-3"/>
        <point x="18" y="-19.5"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Sort_1" port="1" iotype="out"/>
      <to block="Display_2" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="32.83753776550293" y="99.02065467834473"/>
        <point x="32.83753776550293" y="86.52065467834473"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Constant_1" port="1" iotype="out"/>
      <to block="Sort_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-44.66246223449707" y="105.02065467834473"/>
      </points>
    </link>
    <context/>
    <graphics>
