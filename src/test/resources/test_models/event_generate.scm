...
<model name="event_generate">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/28/19 08:42:35"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/28/19 08:58:52"/>
  ...
  <diagram>
    <block name="EventGenerate" type="block">
      ...
      <graphics>
        ...
        <position x="292.9459228515625" y="60.915992736816406"/>
    ...
    <block name="EventScope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="292.9459228515625" y="214.91598510742188"/>
    ...
    <block name="EventScope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="332.94592285156256" y="284.9159851074219"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="EventGenerate" port="2" iotype="out"/>
