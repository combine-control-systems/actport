...
<model name="ramp_saturate">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/03/19 10:31:19"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 11:45:43"/>
  ...
  <finalization/>
  <diagram>
    <block name="RampSaturate" type="block">
      <template name="system/SignalGenerators/RampSaturate"/>
      <properties>
      ...
      <graphics>
        ...
        <images>
          <image name="image1" file="SignalGenerators/Ramp_no_ports.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="SignalGenerators/Ramp_mirrored_no_ports.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="height" value="5"/>
          <parameter name="duration" value="5"/>
          <parameter name="offset" value="-3"/>
          <parameter name="startTime" value="15"/>
        </section>
      </parameters>
    </block>
    ...
    <block name="RampSaturate_1" type="block">
      <template name="system/SignalGenerators/RampSaturate"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="startTime" value="3"/>
        </section>
      </parameters>
    </block>
    ...
    <link name="" type="explicit">
      ...
      <to block="RampSaturate" port="1" iotype="out"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="RampSaturate_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <context/>
