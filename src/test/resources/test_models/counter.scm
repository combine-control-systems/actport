...
<model name="counter">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="06/03/19 13:28:22"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 14:34:05"/>
  ...
  <diagram>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="76.39481353759766" y="49.31554794311523"/>
    ...
    <block name="Counter_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-49" y="40.49999999999999"/>
        <size width="60" height="60.00000000000001"/>
        <rotate angle="0"/>
        <texts>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="minim" value="-2"/>
          <parameter name="step" value="1"/>
          <parameter name="maxim" value="4.3"/>
          <parameter name="Initv" value="9.5"/>
          <parameter name="rule" value="&apos;Decrement&apos;"/>
    ...
    <block name="Scope_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="72.68294405937195" y="179.50601959228516"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Counter_1_1" type="block">
      <template name="system/SignalGenerators/Counter"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-51.31705594062805" y="166.50601959228516"/>
    ...
    <block name="Block" type="activation_split">
      ...
      <graphics>
        ...
        <background color="183,15,19,255"/>
        <position x="-86.048828125" y="20.15852546691896"/>
    ...
    <block name="Counter" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-60.256189346313526" y="-60.05484771728517"/>
        <size width="60" height="60"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Counter&#xA;0&#xA;4</text>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="minim" value="0"/>
          <parameter name="step" value="1"/>
          <parameter name="maxim" value="4"/>
          <parameter name="Initv" value="0"/>
          <parameter name="rule" value="&apos;Increment&apos;"/>
          <parameter name="typ" value="&apos;int16&apos;"/>
        </section>
      </parameters>
    </block>
    <block name="ActivationSplit" type="activation_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="183,15,19,255" thickness="1.5"/>
        <background color="183,15,19,255"/>
        <position x="-35" y="-79.81856155395509"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="Counter_1_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="40.68294405937195" y="199.50601959228516"/>
        <point x="40.68294405937195" y="196.50601959228516"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Counter_1_1" port="1" iotype="in"/>
      <to block="Block" port="1" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-86.04882812499994" y="156.5060195922852"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Counter_1" port="1" iotype="in"/>
      <to block="Block" port="2" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-19.000000000000004" y="20.158525466918924"/>
      </points>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_1" port="1" iotype="in"/>
      <to block="Counter_1" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="43.69740676879883" y="69.31554794311523"/>
        <point x="43.69740676879883" y="70.5"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Counter" port="1" iotype="in"/>
      <to block="ActivationSplit" port="2" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-30.2561893463135" y="-79.81856155395506"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-35" y="-86.00000000000001"/>
        <point x="-86.04882812500003" y="-86"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="37.87190532684323" y="-30.05484771728517"/>
        <point x="37.87190532684323" y="-32"/>
      </points>
    </link>
    <context/>
    <graphics>
