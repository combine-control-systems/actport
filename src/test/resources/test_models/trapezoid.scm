...
<model name="trapezoid">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="05/17/19 14:33:53"/>
  ...
  <finalization/>
  <diagram>
    <block name="Trapezoid" type="block">
      <template name="system/SignalGenerators/Trapezoid"/>
      <properties>
      ...
      <graphics>
        ...
        <images>
          <image name="image1" file="SignalGenerators/Trapezoid_no_ports.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="SignalGenerators/Trapezoid_mirrored_no_ports.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="amplitude" value="2"/>
          <parameter name="rising" value=".5"/>
          <parameter name="width" value="3"/>
          <parameter name="falling" value="1"/>
          <parameter name="period" value="5"/>
          <parameter name="nperiod" value="-1"/>
    ...
    <link name="" type="Explicit">
      ...
      <from block="Trapezoid" port="1" iotype="out"/>
