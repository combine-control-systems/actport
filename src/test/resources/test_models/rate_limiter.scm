...
<model name="rate_limiter">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 12:57:47"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 12:58:50"/>
  ...
  <diagram>
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <position x="-129.0505714416504" y="-55.309172312418625"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="111.94943237304688" y="-53.72583897908528"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="RateLimiter" type="block">
      <template name="system/Hybrid/RateLimiter"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
        <property name="atomic" value="0"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-13.5505690574646" y="-49.01750564575195"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
        ...
        <images>
          <image name="image1" file="Hybrid/rateLimiter.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="Hybrid/rateLimiter.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="upper" value="0.7"/>
          <parameter name="lower" value="-0.7"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="RateLimiter" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-51.300570249557495" y="-35.309172312418625"/>
        <point x="-51.300570249557495" y="-29.017505645751953"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="RateLimiter" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="69.19943165779114" y="-29.017505645751953"/>
        <point x="69.19943165779114" y="-33.72583897908528"/>
      </points>
    </link>
    <context/>
    <graphics>
