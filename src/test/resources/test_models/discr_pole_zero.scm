...
<model name="discr_pole_zero">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 09:12:41"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 09:15:55"/>
  ...
  <finalization/>
  <diagram>
    <block name="DiscrPoleZero" type="block">
      <template name="system/Dynamical/DiscrPoleZero"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="47.89328384399414" y="213.97048950195313"/>
        <size width="60" height="60"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"> z&#xA;──────────&#xA;(z+1)(z-1)</text>
        </texts>
        <images>
    ...
    <block name="Step Generator_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-122.63323211669922" y="222.39216661453247"/>
    ...
    <block name="Sum" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-53.63323211669922" y="222.6557240486145"/>
    ...
    <block name="Gain" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,255"/>
        <position x="63.50636863708496" y="299.95027112960815"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="205.7612533569336" y="210.26615190505981"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="139.1597442626953" y="243.97048950195313"/>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-63.63323211669922" y="319.95027112960815"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-68.13323211669922" y="237.6557240486145"/>
        <point x="-68.13323211669922" y="242.39216661453247"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="DiscrPoleZero" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="139.1597442626953" y="319.95027112960815"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="156.82726860046387" y="243.97048950195313"/>
        <point x="156.82726860046387" y="230.26615190505981"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="DiscrPoleZero" port="1" iotype="in"/>
      <to block="Sum" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="17.13002586364746" y="243.97048950195313"/>
        <point x="17.13002586364746" y="252.6557240486145"/>
      </points>
    </link>
    <context/>
    <graphics>
