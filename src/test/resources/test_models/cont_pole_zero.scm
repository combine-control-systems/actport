...
<model name="cont_pole_zero">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/05/19 09:06:14"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 09:11:38"/>
  ...
  <finalization/>
  <diagram>
    <block name="ContPoleZero" type="block">
      <template name="system/Dynamical/ContPoleZero"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="21.628456115722656" y="-5.835838317871094"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="zer" value="[0]"/>
          <parameter name="pol" value="[-1,-1]"/>
          <parameter name="k_gain" value="1"/>
        </section>
      </parameters>
    </block>
    <block name="Step Generator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-158.44854736328125" y="9.345581531524658"/>
    ...
    <block name="Sum" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-89.44854736328125" y="9.609138965606689"/>
    ...
    <block name="Gain" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,255"/>
        <position x="27.69105339050293" y="86.90368604660034"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="169.94593811035156" y="-2.780433177947998"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="111.3943099975586" y="24.164161682128906"/>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-99.44854736328125" y="106.90368604660034"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-103.94854736328125" y="24.60913896560669"/>
        <point x="-103.94854736328125" y="29.345581531524658"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ContPoleZero" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="111.3943099975586" y="106.90368604660034"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="125.78719711303711" y="24.164161682128906"/>
        <point x="125.78719711303711" y="17.219566822052002"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ContPoleZero" port="1" iotype="in"/>
      <to block="Sum" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-13.910045623779297" y="24.164161682128906"/>
        <point x="-13.910045623779297" y="39.60913896560669"/>
      </points>
    </link>
    <context/>
    <graphics>
