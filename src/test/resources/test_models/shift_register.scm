...
<model name="shift_register">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="07/09/19 10:13:17"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="07/09/19 11:19:07"/>
  ...
  <finalization/>
  <diagram>
    <block name="ShiftRegister" type="block">
      <template name="system/Dynamical/ShiftRegister"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-54.5" y="-11.5"/>
        <size width="60" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Shift&#xA;Register</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="z0" value="[-1,-2,-3]"/>
          <parameter name="type" value="&apos;inherit&apos;"/>
    ...
    <block name="Step Generator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-386.5" y="-54.699999999999996"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Sum" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-222.5" y="-45.5"/>
        <size width="36" height="108"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
        </texts>
    ...
    <block name="Step Generator_1_1" type="block">
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="steptime" value="3"/>
          <parameter name="iniv" value="0"/>
          <parameter name="finv" value="1"/>
        </section>
      </parameters>
    </block>
    <block name="Step Generator_1_2" type="block">
      <template name="system/SignalGenerators/StepGenerator"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-386.5" y="126.20000000000002"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Step Generator_1_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-386.5" y="184.20000000000002"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ShiftRegister" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-313.5" y="19.5"/>
        <point x="-313.5" y="-13.099999999999984"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Sum" port="1" iotype="out"/>
      <to block="ShiftRegister" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator_1_1" port="1" iotype="out"/>
      <to block="Sum" port="3" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-294.5" y="77.5"/>
        <point x="-294.5" y="8.5"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator_1_2" port="1" iotype="out"/>
      <to block="Sum" port="4" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-279.49999999999994" y="146.20000000000002"/>
        <point x="-279.5" y="30.099999999999994"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Step Generator_1_1_1" port="1" iotype="out"/>
      <to block="Sum" port="5" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-265.5" y="204.19999999999987"/>
        <point x="-265.5" y="51.69999999999999"/>
      </points>
    </link>
    <context/>
    <graphics>
