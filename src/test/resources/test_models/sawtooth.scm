...
<model name="sawtooth">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="05/17/19 21:28:12"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/17/19 22:09:53"/>
  ...
  <finalization/>
  <diagram>
    <block name="Sawtooth" type="block">
      <template name="system/SignalGenerators/Sawtooth"/>
      <properties>
      ...
      <graphics>
        ...
        <images>
          <image name="image1" file="SignalGenerators/sawtooth.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="SignalGenerators/sawtooth.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="down" value="[1, 3]"/>
          <parameter name="up" value="[2, -1]"/>
          <parameter name="tinit" value="2"/>
        </section>
      </parameters>
    </block>
    ...
    <block name="Sawtooth_1" type="block">
      <template name="system/SignalGenerators/Sawtooth"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="down" value="[-3, 4]"/>
          <parameter name="up" value="2"/>
          <parameter name="tinit" value="0"/>
        </section>
      </parameters>
    </block>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Sawtooth" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Sawtooth_1" port="1" iotype="out"/>
