...
<model name="deadzone">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="06/05/19 12:54:59"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/05/19 12:55:48"/>
  ...
  <diagram>
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <position x="98.94943284988403" y="-90.43416849772134"/>
    ...
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-142.05057096481323" y="-92.01750183105469"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Deadzone" type="block">
      <template name="system/Hybrid/Deadzone"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
        <property name="atomic" value="0"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-15.5505690574646" y="-98.01750183105469"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
        ...
        <images>
          <image name="image1" file="Hybrid/deadzone.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="Hybrid/deadzone.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="upper" value="0.5"/>
          <parameter name="lower" value="-0.5"/>
          <parameter name="zeroc" value="1"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Deadzone" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="61.69943189620972" y="-78.01750183105469"/>
        <point x="61.69943189620972" y="-70.43416849772134"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Deadzone" port="1" iotype="in"/>
      <to block="SineWaveGenerator" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-58.800570011138916" y="-78.01750183105469"/>
        <point x="-58.800570011138916" y="-72.01750183105469"/>
      </points>
    </link>
    <context/>
    <graphics>
