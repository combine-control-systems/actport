...
<model name="sum_elements">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="05/20/19 17:22:33"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/20/19 09:26:40"/>
  ...
  <finalization/>
  <diagram>
    <block name="SumElements" type="block">
      <template name="system/MatrixOperations/SumElements"/>
      <properties>
    ...
    <block name="SumElements_1" type="block">
      <template name="system/MatrixOperations/SumElements"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="overflow" value="&apos;Saturate&apos;"/>
          <parameter name="externalActivation" value="0"/>
        </section>
      </parameters>
    </block>
    <block name="SumElements_1_1" type="block">
      <template name="system/MatrixOperations/SumElements"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SumElements" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="63" y="-16"/>
        <point x="63" y="13.666666666666666"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SumElements_1" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SumElements_1_1" port="1" iotype="out"/>
      <to block="Scope" port="3" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="70.5" y="93"/>
        <point x="70.5" y="40.33333333333333"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SumElements_1" port="1" iotype="in"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="SumElements" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-110" y="-16"/>
      </points>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SumElements_1_1" port="1" iotype="in"/>
