...
<model name="discr_trans_func">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="05/20/19 14:53:10"/>
  ...
  <diagram>
    ...
    <block name="DiscrTransFunc" type="block">
      <template name="system/Dynamical/DiscrTransFunc"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
        <property name="atomic" value="0"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-34.37536668777466" y="-39.99612808227539"/>
        <size width="60" height="60"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">num(z)&#xA;──────&#xA;z+1</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="num" value="[1,0; 1,1; 3,1]"/>
    ...
    <block name="Ramp" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-176.3213348388672" y="-59.405030250549316"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="DiscrTransFunc" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-97.60205864906311" y="-39.40503025054933"/>
        <point x="-97.60205864906311" y="-9.996128082275391"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="DiscrTransFunc" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="68.81231665611267" y="-9.996128082275391"/>
        <point x="68.81231665611267" y="-15"/>
      </points>
    </link>
    <context/>
    <graphics>
