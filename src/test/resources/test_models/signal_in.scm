...
<model name="signal_in">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="07/09/19 06:37:21"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="07/09/19 06:39:15"/>
  ...
  <finalization/>
  <diagram>
    <block name="SignalIn" type="block">
      <template name="system/SignalImporters/SignalIn"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-401.5" y="-309"/>
        <size width="110" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Signal In&#xA;A</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="varnam" value="&apos;A&apos;"/>
          <parameter name="defvalue" value="struct (&apos;time&apos;, 0, &apos;ch&apos;, {{struct(&apos;type&apos;, &apos;double&apos;, &apos;data&apos;, [0])}})"/>
    ...
    <link name="" type="Explicit">
      ...
      <from block="SignalIn" port="1" iotype="out"/>
