...
<model name="variable_time_delay">
  ...
  <finalization/>
  <diagram>
    <block name="VariableDelay" type="block">
      <template name="system/Dynamical/VariableDelay"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-338" y="-321"/>
        <size width="80" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Variable&#xA;Time Delay</text>
        </texts>
        <images>
    ...
    <block name="VariableDelay_1" type="block">
      <template name="system/Dynamical/VariableDelay"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="VariableDelay" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="VariableDelay" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      ...
      <to block="VariableDelay_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-362.5" y="-311"/>
        <point x="-362.5" y="-169"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="VariableDelay" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-379.5" y="-291"/>
      </points>
    ...
    <link name="" type="Explicit">
      ...
      <to block="VariableDelay_1" port="2" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-379.5" y="-149"/>
      </points>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="VariableDelay_1" port="1" iotype="out"/>
