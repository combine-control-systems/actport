...
<model name="toggle">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="06/04/19 07:17:09"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/04/19 07:18:49"/>
  ...
  <finalization/>
  <diagram>
    <block name="Toggle" type="block">
      <template name="system/SignalGenerators/Toggle"/>
      <properties>
      ...
      <graphics>
        ...
        <images>
          <image name="image1" file="SignalGenerators/toggle.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
        <flip value="0">
          <images>
            <image name="image2" file="SignalGenerators/toggle.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
          </images>
        </flip>
      </graphics>
      <ports>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="firstvalue" value="[2 1; -5 7]"/>
          <parameter name="secondvalue" value="[5 6; -24 0]"/>
          <parameter name="ot" value="&apos;int8&apos;"/>
        </section>
      </parameters>
    </block>
    <block name="Toggle_1" type="block">
      <template name="system/SignalGenerators/Toggle"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <parameters>
        <section name="Parameters">
          ...
          <parameter name="secondvalue" value="-1"/>
    ...
    <link name="" type="Activation">
      ...
      <to block="Toggle_1" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="9.000000000000002" y="18.500000000000004"/>
        <point x="7.999999999999998" y="18.500000000000004"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampleClock" port="1" iotype="out"/>
      <to block="Toggle" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="13.000000000000004" y="-122"/>
        <point x="8.999999999999998" y="-122"/>
      </points>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope_1" port="1" iotype="in"/>
      <to block="Toggle_1" port="1" iotype="out"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="Toggle" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <context/>
