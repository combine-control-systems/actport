...
<model name="event_delay">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/27/19 14:03:58"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/27/19 14:16:13"/>
  ...
  <diagram>
    <block name="EventDelay" type="block">
      ...
      <graphics>
        ...
        <position x="380.6792907714844" y="158.81846618652344"/>
    ...
    <block name="EventClock" type="block">
      ...
      <graphics>
        ...
        <position x="395.6792907714844" y="58.81846618652344"/>
    ...
    <block name="EventScope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="395.6792907714843" y="292.8184814453125"/>
      ...
      <ports>
        <port name="&quot;1&quot; &quot;2&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Activation"/>
    ...
    <block name="ActivationSplit" type="activation_split">
      ...
      <graphics>
        ...
        <background color="183,15,19,255"/>
        <position x="420.6792907714844" y="129.81846618652344"/>
    ...
    <link name="" type="Activation">
      ...
      <to block="EventScope" port="2" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="420.6792907714843" y="282.8184814453187"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ActivationSplit" port="1" iotype="out"/>
      <to block="EventDelay" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Activation">
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="365.6792907714843" y="129.81846618652318"/>
        <point x="365.6792907714844" y="228.81846618652344"/>
        <point x="405.6792907714842" y="228.8184661865232"/>
      </points>
    </link>
    <context/>
    <graphics>
