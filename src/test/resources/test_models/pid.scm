...
<model name="pid">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="05/17/19 05:53:57"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/17/19 06:08:59"/>
  ...
  <diagram>
    <block name="PID" type="block">
      ...
      <graphics>
        ...
        <position x="-379.5660095214844" y="-398.7449645996094"/>
      ...
      <parameters>
        <section name="Gain">
          ...
          <parameter name="Ki" value="3"/>
          <parameter name="Kd" value="0.1"/>
          <parameter name="N" value="150"/>
        </section>
      </parameters>
    </block>
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-246.56600952148438" y="-398.7449645996094"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-511.5660095214844" y="-398.7449645996094"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
