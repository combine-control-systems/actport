...
<model name="last_input">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Stefan Larsson"/>
      <property name="creationdate" value="05/28/19 04:52:56"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/28/19 04:57:28"/>
  ...
  <finalization/>
  <diagram>
    <block name="Triggered by Event Clock" type="block">
      ...
      <graphics>
        ...
        <position x="385.6792907714844" y="176.81846618652344"/>
    ...
    <block name="Continuous" type="block">
      <template name="system/Hybrid/LastInput"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="385.6792907714844" y="297.8184814453125"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Last&#xA;Input</text>
    ...
    <block name="SineWaveGenerator" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="228.67927551269537" y="240.81846618652344"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="329.6792831420899" y="260.81846618652344"/>
    ...
    <block name="Triggered by Sample Clock" type="block">
      <template name="system/Hybrid/LastInput"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="385.6792907714844" y="26.818466186523438"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">Last&#xA;Input</text>
    ...
    <block name="SampleClock" type="block">
      ...
      <graphics>
        ...
        <position x="385.6792907714844" y="-55.68153381347656"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="EventClock" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,0"/>
        <position x="380.67929077148455" y="90.81846618652344"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="329.6792831420899" y="196.81846618652344"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="521.6792602539063" y="26.818466186523438"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="521.6792602539063" y="176.81846618652344"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope_1_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="521.6792602539063" y="297.8184814453125"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="Continuous" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="329.6792831420899" y="317.8184814453125"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="SampleClock" port="1" iotype="out"/>
      <to block="Triggered by Sample Clock" port="1" iotype="in"/>
    ...
    <link name="" type="Activation">
      ...
      <to block="Triggered by Event Clock" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="329.6792831420899" y="46.81846618652344"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Triggered by Sample Clock" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Triggered by Event Clock" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Continuous" port="1" iotype="out"/>
