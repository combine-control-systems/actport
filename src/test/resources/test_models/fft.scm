...
<model name="fft">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="05/20/19 08:37:05"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="05/20/19 08:53:14"/>
  ...
  <diagram>
    <block name="FFT" type="block">
      ...
      <graphics>
        ...
        <position x="-836.1889343261719" y="-774.1406860351563"/>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-755.9631500244141" y="-767.1406860351563"/>
        <size width="504" height="36"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">     1 +    -0i  -0.809017 -0.587785i  0.309017 +0.951057i  0.309017 -0.951057i  -0.809017 +0.587785i</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-986.0551452636719" y="-761.1406860351563"/>
        <size width="120" height="24"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">[0,0,1,0,0]</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="C" value="[0,0,1,0,0]"/>
