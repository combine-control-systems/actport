...
<model name="compare_to_constant">
  <header formatversion="2" hwxversion="2019.2" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="pablo"/>
      <property name="creationdate" value="06/03/19 09:16:48"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="06/03/19 09:18:25"/>
  ...
  <diagram>
    ...
    <block name="CompareToConstant" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">u1 &lt; 5</text>
        </texts>
        <images>
    ...
    <block name="CompareToConstant_1" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">u1 == 0</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <link name="" type="Explicit">
      ...
      <to block="CompareToConstant" port="1" iotype="in"/>
