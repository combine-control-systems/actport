//package actport.database.transforms
//
//import actport.{ParsedSystem, ParsedBlock, EventLink, InputPort, OutputPort, PortType}
...
//    * @return
//    */
//  def updatePortIndices(system: ParsedSystem): ParsedSystem = {
//    system.children.zipWithIndex.foldLeft(system) { case (s, (block, index)) =>
//      block match {
//        case b: ParsedBlock if b.blockType == "system/Ports/EventInput" => processPort(s, b, index, InputPort)
//        case b: ParsedBlock if b.blockType == "system/Ports/EventOutput" => processPort(s, b, index, OutputPort)
//        case ss: ParsedSystem => s.lens(_.children).modify(_.updated(index, updatePortIndices(ss)))
//        case _: ParsedBlock => s
//      }
//    }
//  }
//
//  private def processPort(system: ParsedSystem, block: ParsedBlock, index: Int, portType: PortType): ParsedSystem = {
